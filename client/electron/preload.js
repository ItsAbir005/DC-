...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Download operations
  requestDownloadToken: (fileHash, uploader) =>
    ipcRenderer.invoke('client:requestDownloadToken', { fileHash, uploader }),

  startDownload: (downloadInfo) =>
    ipcRenderer.invoke('client:startDownload', downloadInfo),

  pauseDownload: (fileHash) =>
    ipcRenderer.invoke('client:pauseDownload', { fileHash }),

  resumeDownload: (fileHash) =>
    ipcRenderer.invoke('client:resumeDownload', { fileHash }),
